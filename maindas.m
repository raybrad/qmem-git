...
dembv=tdembv(VT);
[currentT1,currddT1]=tdcurrent([3,6,6],1,nsteps);
[currentT2,currddT2]=tdcurrent([kx-2,6,6],1,nsteps);
...
save('currqmem1.dat','ansv3','-ASCII');
...
ansv3=[scl.Vt*VT(901,:)',scl.Vt*dembv,currentT1*scl.s_Curr*1e9,-currentT2*scl.s_Curr*1e9,...
currentT3*scl.s_Curr*1e9,-currentT4*scl.s_Curr*1e9,curr(1:nsteps,2),curr(1:nsteps,3),...
tdqmcurrd(1:nsteps,2)*0.75*0.75*1e-9,-tdqmcurrd(1:nsteps,3)*0.75*0.75*1e-9];

save('currqmem1n.dat','ansv3','-ASCII');
