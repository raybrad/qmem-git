function [dtV,dtn,dtp,dtH] = tdcalupdatesc(V,n,p,A,H,dtVp,dtHp)
...
eqnLinks = setdiff((1:Nlink)',[bndLinks;QMlinks]);
...
for l1 = eqnLinks'
        ...
        elseif isSQMlinks(l1) == 1
            dtH(l1) = dtH(l1) - scl.K * linkS(l1)*currdlink(l1,4);
        elseif isSQMlinks(l1) == 2
            dtH(l1) = dtH(l1) - scl.K * linkS(l1)*currdlink(l1,4);
        elseif isSQMlinks(l1) == 3
            dtH(l1) = dtH(l1) - scl.K * linkS(l1)*currdlink(l1,6);
        else
            dtH(l1) = dtH(l1) + 0;
        end
