function [currentT,currddT] = tdcurrentf(cod,dir,nsteps)
	 ...
	 for t = 1:length(slkvol)
		switch slkvolm(t)
			case 1
                                ...
                                J = 0*J_diff + epsilon_sd*dtE1;
			case 2
                                J = 0*sigma*((V(n1)-V(n2)+dV1-dV2)/slinkl - H(slink))+ epsilon_mt*dtE1;
			case 3
                                J = epsilon_in*dtE1;
                        case 4
                                beta = V(n2)-V(n1)+H(slink)*slinkl;
