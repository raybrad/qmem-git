...
%%%%%%%%%%% CNT1 %%%%%%%%%%%%%%%%%%
X1 = 4; X2 = 44; Y1 = 3; Y2 = 19; Z1 = 3; Z2 = 19; Xm1 = 20; Xm2 = 28; Ym = 9; Ym2 = 21; Zm = 9;
Ym1 = 9;
...
contnodes1    = defBrickNodes([Xm1,1,1],[Xm2,1,kz+1]);
contnodes2    = defBrickNodes([Xm1,ky+1,1],[Xm2,ky+1,kz+1]);
contnodes3    = defBrickNodes([Xm1,1,kz+1],[Xm2,ky+1,kz+1]);
contnodes4    = defBrickNodes([Xm1,1,1],[Xm2,ky+1,1]);
