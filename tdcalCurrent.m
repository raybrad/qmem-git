function [Jx,Jy,Jz] = calCurrent(nodes,V,n,p,A,H,dtVp,dtHp)
        ...
        for j = 1:length(ajvol_lk)
            switch ajvolM_lk(j)
                case 1
                    ...
                    J_(j) = Jc(alpha_n,beta,'n',n(n1),n(n2))...
                        +Jc(alpha_p,beta,'p',p(n1),p(n2))+ epsilon_sd*dtE1;
                case 2
                    J_(j) = sigma*((V(n1)-V(n2)+dV1-dV2)/linkL(lk) - sign_n1(i)*H(lk))+ epsilon_mt*dtE1;
                case 3
