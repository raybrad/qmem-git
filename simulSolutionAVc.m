function [V,n,p,A] = simulSolutionAV(Vs,ns,ps,V,n,p,A,fren,currdlink)

display(['Start dynamic solution cdbc at 1e',num2str(log10(fren)),' Hz']);
...
display(['End dynamic solution cdbc at 1e',num2str(log10(fren)),' Hz']);
