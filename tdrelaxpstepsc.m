function [V,n,p,A,H] = tdrelaxpstepc(V_p,n_p,p_p,A_p,H_p,dtV,dtn,dtp,dtH,dt)

display(['  Start TD simulation relaxationc per step:']);
    ...
    %%%%%%%%%%%%% Build Jacobian and rhs of G (Ampere's law) %%%%%%%%%%%%%
     for l1 = eqnLinks'
        ...
        elseif isSQMlinks(l1) == 3
            rhs_G(l1) = rhs_G(l1) - scl.K * linkS(l1)*currdlink(l1,6);
...
display(['  End TD simulation relaxationc per step.']);
